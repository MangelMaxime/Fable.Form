    ...
    module View =
        ...
        let formListItem
            ...
            let removeButton =
                ...
                | (false, Some delete) ->
                    bulma.button.a [
                        Ev.onClick (fun _ -> delete.Action())
            ...
            View.formList
                {
                    Forms =
                        ...
                        |> List.map (fun
                            ...
                            View.formListItem
                                {
                                    Fields = List.map (Helpers.View.renderField fieldConfig) fields
                                    Delete =

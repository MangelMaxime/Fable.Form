...
type Model =
    | FillingForm of Form.View.Model<Composability.Simple.Values>
    | Submitted of Name * Address

type Msg =
    // Used when a change occure in the form
    | FormChanged of Form.View.Model<Composability.Simple.Values>
...
let init () =
    Composability.Simple.init |> FillingForm, Cmd.none

...
type IExports =
    ...
    abstract notDeepEqual: actual: 'T * expected: 'T option * ?message: U2<string, Error> -> unit
...
[<AllowNullLiteral>]
type AssertionErrorStatic =
    [<EmitConstructor>]
    abstract Create: ?options: AssertionErrorStaticOptions -> AssertionError

[<AllowNullLiteral>]
type AssertionErrorStaticOptions =
...
type AssertPredicate = U5<RegExp, obj, (obj option -> bool), obj, Error>
